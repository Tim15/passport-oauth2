 ...
 *   - `tokenCallbackURL`  URL to which the service provider will redirect the user after obtaining the token
...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.query && req.query.code) {
    ...
    if (options.tokenCallbackURL || callbackURL) { params.redirect_uri = options.tokenCallbackURL || callbackURL; }
